...
/**
 * BAAI bge-large-en-v1.5 embedding model that runs within your Java application's process.
 * <p>
 ...
 * <p>
 * More details <a href="https://huggingface.co/BAAI/bge-large-en-v1.5">here</a>
 */
public class BgeLargeEnV15EmbeddingModel extends AbstractInProcessEmbeddingModel {

    private static final OnnxBertBiEncoder MODEL = loadFromJar(
            "bge-large-en-v1.5.onnx",
            "bge-large-en-v1.5-tokenizer.json",
            PoolingMode.CLS
    );

    /**
     * Creates an instance of an {@code BgeLargeEnV15EmbeddingModel}.
     * Uses a cached thread pool with the number of threads equal to the number of available processors.
     * Threads are cached for 1 second.
     */
    public BgeLargeEnV15EmbeddingModel() {
        super(null);
    }
     ...
     */
    public BgeLargeEnV15EmbeddingModel(Executor executor) {
